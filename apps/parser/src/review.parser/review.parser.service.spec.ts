  ...
  beforeEach(async () => {
    ...
    mock = mockPuppeteerGoto(page, {
      paths: {
        ...
        [review1]: 'apps/parser/src/review.parser/user-reviews-1.html',
        [review2]: 'apps/parser/src/review.parser/user-reviews-2.html',
        [review3]: 'apps/parser/src/review.parser/user-reviews-3.html',
      },
    });
  });

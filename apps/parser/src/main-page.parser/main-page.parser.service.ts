...
import { countryXpath, genreXpath, origTitleXpath, sloganXpath, timeXpath, titleXpath } from '../xpath/main-page';
import { MPAA_Link, minAgeXpath, restrictionAbbrivaitaionXpath, restrictionShortDescriptionXpath, } from '../xpath/age-restriction';
